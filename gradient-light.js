// gradient-light.js - Light theme gradient matching reference image
...
function normalizeColor(hexCode) {
        ...
        Mesh: {
          ...
          value: class {
            ...
            draw() {
              ...
              context.drawElements(this.wireframe ? context.LINES : context.TRIANGLES,
  ...
  class Gradient {
    constructor(...t) {
      ...
      e(this, "animate", e => {
        if (!this.shouldSkipFrame(e) || this.isMouseDown) {
          // Utilisation de la nouvelle vitesse d'animation
          let delta = Math.min(e - this.last, this.animationSpeed);
          this.t += delta;
          this.last = e;
          if (this.isMouseDown) {
            let adjust = 160;
            this.isMetaKey && (adjust = -160);
            this.t += adjust;
          }
    ...
    */
    initGradientColors() {
      // Couleurs exactes de l'image de référence : gradient clair vert/turquoise/blanc
      this.sectionColors = [
        '0xF0F5F4',
        '0xD5EDE5',
        '0x7DD9A8',
